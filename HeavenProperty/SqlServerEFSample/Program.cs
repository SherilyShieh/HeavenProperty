        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (EFSampleContext context = new EFSampleContext(builder.ConnectionString))
                {
                    ...
                    Seller newUser = new Seller { FirstName = "Anna", LastName = "Shrestinian", Address = "Jonhsonville, Wellington",
                    Email = "Anna@gmail.com", Password = "anna@123", Phone = "0232453789"};
                    ...
                    Property newTask = new Property() { Title = "Ship Helsinki", Seller_Id = 1, BathRooms = 1, Rooms = 2, CarParkings = 3, Email = "test@gmail.com",
                        FloorArea = "80", LandArea = "100", Location = "18 Bell Street, Tawa, Wellington", RV = "$1000,000", Type = "House"};
